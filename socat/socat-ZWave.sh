...
scriptHome=$P5SoftwareHome/socat

# Read the configuration file
source $scriptHome/socat-ZWave.conf

PATH=/sbin:/usr/sbin:/bin:/usr/bin
DESC="Creates a TCP-to-serial bridge for ZWave using Socat"   # String describing the service
NAME="socat-ZWave"                     # Name of the service, will be used in another vars
DAEMON=$socatLocation     # Path to the service executable, e.g. /usr/bin/java
